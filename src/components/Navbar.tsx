...
export function Navbar() {
    ...
    return (
        <nav className="bg-slate-400 px-2 py-2.5 dark:bg-gray-900 sm:px-4">
            <div className="container mx-auto flex flex-wrap items-center justify-between">
                <div style={{ position: "unset" }}>
                    <Link href="/" className="flex items-center">
                        <Image
                            src="/images/dnd-logos/dnd-emblem-logo-fullsize.png"
                            className="mr-3"
                            alt="D&D Logo"
                            width={48}
                            height={48}
                ...
                <div className="flex w-auto items-center justify-between">
                    <ul className="mt-0 flex flex-row space-x-8 rounded-lg border border-gray-100 bg-slate-500 text-sm font-medium dark:border-gray-700 dark:bg-gray-900">
                        <li>
                ...
                <div className="flex items-center">
                    <Image
                        className="z-10 h-8 w-8 rounded-full object-cover"
